...
import 'package:flutter_folio/views/editor_page/panels/collapsable_info_panel.dart';
import 'package:flutter_folio/views/editor_page/panels/collapsable_pages_panel.dart';
...
class CollapsablePanels extends StatelessWidget {
  const CollapsablePanels(this.bookId, this.pages, {Key key, @required this.width}) : super(key: key);
  final String bookId;
            ...
            Positioned(
              ...
              child: Column(
                children: [
                  ...
                  VSpace.lg,
                  // Pages Panel
                  CollapsablePagesPanel(pages, height: bottomPanelHeight),
                ],
              ), // BookPagesMenu(),
            )
          ],
