...
class LinuxMinimizeIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(); //SvgPicture.string(_linuxMinimizeIconSvg, color: color);
  }
}
...
class LinuxMaximizeIcon extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Container(); //SvgPicture.string(_linuxMaximizeIconSvg, color: color);
  }
}
...
class LinuxUnmaximizeIcon extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Container(); //SvgPicture.string(_linuxUnmaximizeIconSvg, color: color);
  }
}
...
class LinuxCloseIcon extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Container(); //SvgPicture.string(_linuxCloseIconSvg, color: color);
  }
}
